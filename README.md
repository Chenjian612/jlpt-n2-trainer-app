...
截至 2026-09-12，`M0：可用`、`M1：有效` 已完成，`M2：可信` 正在进行真实使用与发布前验收。文法/词汇错题、学习包、官方词卡、文法 200 条、读解和听力弱点已经进入统一间隔复习调度；错误趋势已改为逐次事件统计，采集满 14 天后开始展示可靠的前后 7 天对比。最新状态见 [开发现状报告](./STATUS-2026-09-07.md)。
