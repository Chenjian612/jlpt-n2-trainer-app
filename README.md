...
- 已完成 AI-M1 与 AI-M2：个性化错误诊断、三步判断路径、易混点对比、复习动作、AI 迁移题记录与固定质量评估
...
截至 2026-09-12，`M0：可用`、`M1：有效` 已完成，`M2：可信` 正在进行真实使用与发布前验收。文法/词汇错题、学习包、官方词卡、文法 200 条、读解和听力弱点已经进入统一间隔复习调度；错误趋势已改为逐次事件统计，首页会显示采集天数和 14 天错误样本量，采集满 14 天后开始展示可靠的前后 7 天对比。最新状态见 [开发现状报告](./STATUS-2026-09-07.md)。
