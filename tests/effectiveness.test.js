...
module.exports = { name: 'effectiveness', tests: [
  { name: 'summarizes due work, repeated errors, spaced progress and transfer accuracy', run() {
    const state = {
      ...
      sessionsByDay: { '2026-09-08': [{ id: 'a', modeId: 'grammar_drill', kind: 'drill', completedAt: '2026-09-08T09:00:00Z' }], '2026-09-07': [{ id: 'b', modeId: 'reading_drill', kind: 'drill', completedAt: '2026-09-07T09:00:00Z' }] },
      wrongAnswers: [{ mastered: false, wrongCount: 2, modeId: 'grammar_drill', nextReviewAt: '2026-09-08', questionId: 'g' }],
      weaknessSignals: [{ active: true, wrongCount: 2, reviewBox: 2, nextReviewAt: '2026-09-08T00:00:00Z', modeId: 'reading_drill', questionId: 'r' }],
      studyWeaknesses: [{ active: true, unstableCount: 2, reviewBox: 3, nextReviewAt: '2026-09-08T00:00:00Z', modeId: 'grammar_study', id: 's' }],
